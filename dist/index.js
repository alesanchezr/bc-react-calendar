...
/* harmony import */ var _emotion_stylis__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(166);
/* harmony import */ var stylis_rule_sheet__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(167);
...
/* harmony import */ var _emotion_unitless__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(168);
/* harmony import */ var _emotion_is_prop_valid__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(169);
/* harmony import */ var merge_anything__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(170);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var shallowequal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(6);
...
function createStylisInstance(_temp) {
  ...
  var stylis = new _emotion_stylis__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"](options); // Wrap `insertRulePlugin to build a list of rules,
...
function useStyledComponentImpl(forwardedComponent, props, forwardedRef) {
  ...
  if (shouldFilterProps) {
    ...
    for (var key in computedProps) {
      ...
      } else if (key !== 'as' && key !== 'forwardedAs' && (!isTargetTag || Object(_emotion_is_prop_valid__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(key))) {
...
function createStyledComponent(target, options, rules) {
  ...
  Object.defineProperty(WrappedStyledComponent, 'defaultProps', {
    ...
    set: function set(obj) {
      // $FlowFixMe
      this._foldedDefaultProps = isTargetStyledComp ? Object(merge_anything__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"])(target.defaultProps, obj) : obj;
    }
  });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return isRefable; });
...
function checkDecoratorArguments(functionName, signature) {
  if (false) { var arg, _i, _args, _len, args, _key; }
}
...
"use strict";
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(161);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DndContext", function() { return _common__WEBPACK_IMPORTED_MODULE_0__["a"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DndProvider", function() { return _common__WEBPACK_IMPORTED_MODULE_0__["b"]; });

/* harmony import */ var _interfaces__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(25);
/* harmony reexport (checked) */ if(__webpack_require__.o(_interfaces__WEBPACK_IMPORTED_MODULE_1__, "useDrag")) __webpack_require__.d(__webpack_exports__, "useDrag", function() { return _interfaces__WEBPACK_IMPORTED_MODULE_1__["useDrag"]; });

/* harmony reexport (checked) */ if(__webpack_require__.o(_interfaces__WEBPACK_IMPORTED_MODULE_1__, "useDrop")) __webpack_require__.d(__webpack_exports__, "useDrop", function() { return _interfaces__WEBPACK_IMPORTED_MODULE_1__["useDrop"]; });

/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(160);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "useDrag", function() { return _hooks__WEBPACK_IMPORTED_MODULE_2__["a"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "useDrop", function() { return _hooks__WEBPACK_IMPORTED_MODULE_2__["b"]; });

/* harmony import */ var _decorators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(30);
...
function verifyInvariants(sourceIds, monitor, registry) {
  ...
  try {
    for (var _iterator = sourceIds[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var s = _step.value;
      browser_default()(registry.getSource(s), 'Expected sourceIds to be registered.');
    }
  } catch (err) {
...
function drop_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { keys.push.apply(keys, Object.getOwnPropertySymbols(object)); } if (enumerableOnly) keys = keys.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); return keys; }

function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { drop_ownKeys(source, true).forEach(function (key) { drop_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { drop_ownKeys(source).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
function dragOffset_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { keys.push.apply(keys, Object.getOwnPropertySymbols(object)); } if (enumerableOnly) keys = keys.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); return keys; }

function dragOffset_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { dragOffset_ownKeys(source, true).forEach(function (key) { dragOffset_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { dragOffset_ownKeys(source).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
function dragOperation_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { keys.push.apply(keys, Object.getOwnPropertySymbols(object)); } if (enumerableOnly) keys = keys.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); return keys; }

function dragOperation_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { dragOperation_ownKeys(source, true).forEach(function (key) { dragOperation_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { dragOperation_ownKeys(source).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
function reducers_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { keys.push.apply(keys, Object.getOwnPropertySymbols(object)); } if (enumerableOnly) keys = keys.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); return keys; }

function reducers_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { reducers_ownKeys(source, true).forEach(function (key) { reducers_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { reducers_ownKeys(source).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
var browser_asap = __webpack_require__(164);
...
// CONCATENATED MODULE: ./node_modules/dnd-core/dist/esm/index.js


// CONCATENATED MODULE: ./node_modules/react-dnd/lib/common/DndContext.js
...
/* harmony import */ var invariant__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
...
/* harmony import */ var _wrapConnectorHooks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(20);
/* harmony import */ var _utils_isRef__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11);
/* harmony import */ var shallowequal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6);
...
function () {
  ...
  function SourceConnector(backend) {
    ...
    _defineProperty(this, "hooks", Object(_wrapConnectorHooks__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({
...
/* harmony import */ var shallowequal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6);
...
/* harmony import */ var _wrapConnectorHooks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(20);
/* harmony import */ var _utils_isRef__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  ...
  function TargetConnector(backend) {
    ...
    _defineProperty(this, "hooks", Object(_wrapConnectorHooks__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])({
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return isValidType; });
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
// EXTERNAL MODULE: ./node_modules/react-dnd/lib/utils/js_utils.js
var js_utils = __webpack_require__(5);

// CONCATENATED MODULE: ./node_modules/react-dnd/lib/decorators/disposables.js
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  _createClass(Disposable, null, [{
    ...
    value: function isDisposable(d) {
      return d && Object(js_utils["a" /* isFunction */])(d.dispose);
    }
  }, {
    key: "_fixup",
  ...
  function Disposable(action) {
    ...
    this.action = Object(js_utils["a" /* isFunction */])(action) ? action : js_utils["c" /* noop */];
  }
...
_defineProperty(disposables_Disposable, "empty", {
  dispose: js_utils["c" /* noop */]
  /**
...
// EXTERNAL MODULE: ./node_modules/react-dnd/lib/decorators/utils.js
var utils = __webpack_require__(7);

// CONCATENATED MODULE: ./node_modules/react-dnd/lib/decorators/decorateHandler.js
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return decorateHandler; });
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function decorateHandler_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
function decorateHandler(_ref) {
  ...
  var _options$arePropsEqua = options.arePropsEqual,
      arePropsEqual = _options$arePropsEqua === void 0 ? shallowequal_default.a : _options$arePropsEqua;
  ...
  function (_React$Component) {
    ...
    function DragDropContainer(props) {
      ...
      decorateHandler_defineProperty(_assertThisInitialized(_this), "decoratedRef", react["createRef"]());

      decorateHandler_defineProperty(_assertThisInitialized(_this), "handlerId", void 0);

      decorateHandler_defineProperty(_assertThisInitialized(_this), "manager", void 0);

      decorateHandler_defineProperty(_assertThisInitialized(_this), "handlerMonitor", void 0);

      decorateHandler_defineProperty(_assertThisInitialized(_this), "handlerConnector", void 0);

      decorateHandler_defineProperty(_assertThisInitialized(_this), "handler", void 0);

      decorateHandler_defineProperty(_assertThisInitialized(_this), "disposable", void 0);

      decorateHandler_defineProperty(_assertThisInitialized(_this), "currentType", void 0);

      decorateHandler_defineProperty(_assertThisInitialized(_this), "handleChange", function () {
        var nextState = _this.getCurrentState();

        if (!shallowequal_default()(nextState, _this.state)) {
    ...
    decorateHandler_createClass(DragDropContainer, [{
      ...
      value: function getDecoratedComponentInstance() {
        browser_default()(this.decoratedRef.current, 'In order to access an instance of the decorated component, it must either be a class component or use React.forwardRef()');
        return this.decoratedRef.current;
      }
    }, {
      key: "shouldComponentUpdate",
      value: function shouldComponentUpdate(nextProps, nextState) {
        return !arePropsEqual(nextProps, this.props) || !shallowequal_default()(nextState, this.state);
      }
    }, {
      ...
      value: function render() {
        ...
        return react["createElement"](lib["DndContext"].Consumer, null, function (_ref2) {
          ...
          return react["createElement"](Decorated, _extends({}, _this2.props, _this2.getCurrentState(), {
            // NOTE: if Decorated is a Function Component, decoratedRef will not be populated unless it's a refforwarding component.
            ref: Object(utils["c" /* isRefable */])(Decorated) ? _this2.decoratedRef : null
          }));
        });
      }
    }, {
      ...
      value: function receiveDragDropManager(dragDropManager) {
        ...
        browser_default()(dragDropManager !== undefined, 'Could not find the drag and drop manager in the context of %s. ' + 'Make sure to wrap the top-level component of your app with DragDropContext. ' + 'Read more: http://react-dnd.github.io/react-dnd/docs/troubleshooting#could-not-find-the-drag-and-drop-manager-in-the-context', displayName, displayName);
  ...
  decorateHandler_defineProperty(DragDropContainer, "DecoratedComponent", DecoratedComponent);

  decorateHandler_defineProperty(DragDropContainer, "displayName", "".concat(containerDisplayName, "(").concat(displayName, ")"));
...
// CONCATENATED MODULE: ./node_modules/react-dnd/lib/utils/cloneWithRef.js
...
// CONCATENATED MODULE: ./node_modules/react-dnd/lib/common/wrapConnectorHooks.js
...
function wrapHookToRecognizeElement(hook) {
  return function () {
    ...
    if (!Object(react["isValidElement"])(elementOrNode)) {
      var _node = elementOrNode;
      hook(_node, options); // return the node so it can be chained (e.g. when within callback refs
...
// CONCATENATED MODULE: ./node_modules/react-dnd-html5-backend/lib/utils/js_utils.js
// cheap lodash replacements
function memoize(fn) {
  var result = null;
...
// CONCATENATED MODULE: ./node_modules/react-dnd-html5-backend/lib/EnterLeaveCounter.js
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
// CONCATENATED MODULE: ./node_modules/react-dnd-html5-backend/lib/BrowserDetector.js
...
// CONCATENATED MODULE: ./node_modules/react-dnd-html5-backend/lib/MonotonicInterpolant.js
...
// CONCATENATED MODULE: ./node_modules/react-dnd-html5-backend/lib/OffsetUtils.js
...
// CONCATENATED MODULE: ./node_modules/react-dnd-html5-backend/lib/NativeTypes.js
var FILE = '__NATIVE_FILE__';
var URL = '__NATIVE_URL__';
var TEXT = '__NATIVE_TEXT__';
// CONCATENATED MODULE: ./node_modules/react-dnd-html5-backend/lib/NativeDragSources/getDataFromDataTransfer.js
...
// CONCATENATED MODULE: ./node_modules/react-dnd-html5-backend/lib/NativeDragSources/nativeTypesConfig.js
...
// CONCATENATED MODULE: ./node_modules/react-dnd-html5-backend/lib/NativeDragSources/NativeDragSource.js
...
// CONCATENATED MODULE: ./node_modules/react-dnd-html5-backend/lib/NativeDragSources/index.js
...
// CONCATENATED MODULE: ./node_modules/react-dnd-html5-backend/lib/OptionsReader.js
...
// CONCATENATED MODULE: ./node_modules/react-dnd-html5-backend/lib/HTML5Backend.js
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { keys.push.apply(keys, Object.getOwnPropertySymbols(object)); } if (enumerableOnly) keys = keys.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); return keys; }

function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(source, true).forEach(function (key) { HTML5Backend_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(source).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
function () {
  ...
  function HTML5Backend(manager, globalContext) {
    ...
    HTML5Backend_defineProperty(this, "options", void 0);

    HTML5Backend_defineProperty(this, "actions", void 0);

    HTML5Backend_defineProperty(this, "monitor", void 0);

    HTML5Backend_defineProperty(this, "registry", void 0);

    HTML5Backend_defineProperty(this, "enterLeaveCounter", void 0);

    HTML5Backend_defineProperty(this, "sourcePreviewNodes", new Map());

    HTML5Backend_defineProperty(this, "sourcePreviewNodeOptions", new Map());

    HTML5Backend_defineProperty(this, "sourceNodes", new Map());

    HTML5Backend_defineProperty(this, "sourceNodeOptions", new Map());

    HTML5Backend_defineProperty(this, "dragStartSourceIds", null);

    HTML5Backend_defineProperty(this, "dropTargetIds", []);

    HTML5Backend_defineProperty(this, "dragEnterTargetIds", []);

    HTML5Backend_defineProperty(this, "currentNativeSource", null);

    HTML5Backend_defineProperty(this, "currentNativeHandle", null);

    HTML5Backend_defineProperty(this, "currentDragSourceNode", null);

    HTML5Backend_defineProperty(this, "altKeyPressed", false);

    HTML5Backend_defineProperty(this, "mouseMoveTimeoutTimer", null);

    HTML5Backend_defineProperty(this, "asyncEndDragFrameId", null);

    HTML5Backend_defineProperty(this, "dragOverTargetIds", null);

    HTML5Backend_defineProperty(this, "getSourceClientOffset", function (sourceId) {
      return getNodeClientOffset(_this.sourceNodes.get(sourceId));
    });

    HTML5Backend_defineProperty(this, "endDragNativeItem", function () {
    ...
    HTML5Backend_defineProperty(this, "isNodeInDocument", function (node) {
      // Check the node either in the main document or in the current context
      return _this.document && _this.document.body && document.body.contains(node);
    });

    HTML5Backend_defineProperty(this, "endDragIfSourceWasRemovedFromDOM", function () {
    ...
    HTML5Backend_defineProperty(this, "handleTopDragStartCapture", function () {
      _this.clearCurrentDragSourceNode();

      _this.dragStartSourceIds = [];
    });

    HTML5Backend_defineProperty(this, "handleTopDragStart", function (e) {
    ...
    HTML5Backend_defineProperty(this, "handleTopDragEndCapture", function () {
      if (_this.clearCurrentDragSourceNode()) {
    ...
    HTML5Backend_defineProperty(this, "handleTopDragEnterCapture", function (e) {
    ...
    HTML5Backend_defineProperty(this, "handleTopDragEnter", function (e) {
    ...
    HTML5Backend_defineProperty(this, "handleTopDragOverCapture", function () {
      _this.dragOverTargetIds = [];
    });

    HTML5Backend_defineProperty(this, "handleTopDragOver", function (e) {
    ...
    HTML5Backend_defineProperty(this, "handleTopDragLeaveCapture", function (e) {
      if (_this.isDraggingNativeItem()) {
        e.preventDefault();
      }
    ...
    HTML5Backend_defineProperty(this, "handleTopDropCapture", function (e) {
      _this.dropTargetIds = [];
      e.preventDefault();
    ...
    HTML5Backend_defineProperty(this, "handleTopDrop", function (e) {
    ...
    HTML5Backend_defineProperty(this, "handleSelectStart", function (e) {
...
// CONCATENATED MODULE: ./node_modules/react-dnd-html5-backend/lib/getEmptyImage.js
var emptyImage;
...
// CONCATENATED MODULE: ./node_modules/react-dnd-html5-backend/lib/index.js





var lib_createHTML5Backend = function createHTML5Backend(manager, context) {
  return new HTML5Backend_HTML5Backend(manager, context);
};

/* harmony default export */ var react_dnd_html5_backend_lib = (lib_createHTML5Backend);
// EXTERNAL MODULE: ./node_modules/moment/moment.js
var moment = __webpack_require__(0);
var moment_default = /*#__PURE__*/__webpack_require__.n(moment);

// CONCATENATED MODULE: ./src/calendar/Event.js
...
var EventBlock = styled_components_browser_esm["b" /* default */].div(_templateObject(), function (props) {
  return Object(styled_components_browser_esm["a" /* css */])(_templateObject2(), props.index * 2, props.offset);
}, function (props) {
  return props.isDragging && Object(styled_components_browser_esm["a" /* css */])(_templateObject3());
}, function (props) {
  return props.isPreview && Object(styled_components_browser_esm["a" /* css */])(_templateObject4());
}, function (props) {
  return props.direction === "horizontal" ? Object(styled_components_browser_esm["a" /* css */])(_templateObject5(), props.size) : Object(styled_components_browser_esm["a" /* css */])(_templateObject6(), props.size);
});
var EventLabel = styled_components_browser_esm["b" /* default */].label(_templateObject7());
var Invisible = styled_components_browser_esm["b" /* default */].div(_templateObject8());

var Event_Horizon = function Horizon(_ref) {
  ...
  var _useContext = Object(react["useContext"])(CalendarContext),
      toggleDragMode = _useContext.toggleDragMode;

  var _useDrag = Object(lib["useDrag"])({
    item: {
      type: ["top", "left"].includes(orientation) ? ItemTypes.HORIZON_TOP : ItemTypes.HORIZON_BOTTOM,
...
var HorizonStyled = Object(styled_components_browser_esm["b" /* default */])(Event_Horizon)(_templateObject9(), function (props) {
  return Object(styled_components_browser_esm["a" /* css */])(_templateObject10(), props.orientation, ["top", "bottom"].includes(props.orientation) ? "100%" : "10px", ["top", "bottom"].includes(props.orientation) ? "0" : "90");
}, function (props) {
  return Object(styled_components_browser_esm["a" /* css */])(_templateObject11(), ["top", "bottom"].includes(props.orientation) ? "ns-resize" : "ew-resize");
});
var Event_Event = function Event(_ref2) {
  ...
  var _useContext2 = Object(react["useContext"])(CalendarContext),
      timeDirection = _useContext2.timeDirection,
      blockPixelSize = _useContext2.blockPixelSize,
      timeBlockMinutes = _useContext2.timeBlockMinutes,
      toggleDragMode = _useContext2.toggleDragMode;

  var _useDrag3 = Object(lib["useDrag"])({
    item: {
    ...
    begin: function begin(monitor) {
      ...
      _useDrag4 = _slicedToArray(_useDrag3, 2),
      isDragging = _useDrag4[0].isDragging,
      drag = _useDrag4[1];

  return react_default.a.createElement(EventBlock, {
    ref: drag,
    ...
    index: index,
    size: "".concat(Math.floor(duration / timeBlockMinutes * blockPixelSize), "px")
  }, !isPreview && react_default.a.createElement(Invisible, null, react_default.a.createElement(HorizonStyled, {
    index: index,
    orientation: timeDirection === "vertical" ? "top" : "left",
    eventStart: start,
    duration: duration,
    eventEnd: end
  }), react_default.a.createElement(EventLabel, null, label), react_default.a.createElement(HorizonStyled, {
    index: index,
...
Event_Event.propTypes = {
  index: prop_types_default.a.string.isRequired,
  label: prop_types_default.a.string
};
Event_Event.defaultProps = {
  label: "",
  index: "0"
};
// CONCATENATED MODULE: ./src/calendar/TimeBlock.js
function TimeBlock_slicedToArray(arr, i) { return TimeBlock_arrayWithHoles(arr) || TimeBlock_iterableToArrayLimit(arr, i) || TimeBlock_nonIterableRest(); }

function TimeBlock_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance"); }

function TimeBlock_iterableToArrayLimit(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function TimeBlock_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }

function TimeBlock_templateObject4() {
  var data = TimeBlock_taggedTemplateLiteral(["\n          height: ", ";\n        "]);

  TimeBlock_templateObject4 = function _templateObject4() {
    return data;
  };
...
function TimeBlock_templateObject3() {
  var data = TimeBlock_taggedTemplateLiteral(["\n          width: ", ";\n        "]);

  TimeBlock_templateObject3 = function _templateObject3() {
    return data;
  };
...
function TimeBlock_templateObject2() {
  var data = TimeBlock_taggedTemplateLiteral(["\n        background: pink;\n    "]);

  TimeBlock_templateObject2 = function _templateObject2() {
    return data;
  };
...
function TimeBlock_templateObject() {
  var data = TimeBlock_taggedTemplateLiteral(["\n  box-sizing: border-box;\n  font-size: 10px;\n  position: relative;\n  ", "\n  ", "\n\n"]);

  TimeBlock_templateObject = function _templateObject() {
    return data;
  };
...
function TimeBlock_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var Block = styled_components_browser_esm["b" /* default */].div(TimeBlock_templateObject(), function (props) {
  return props.isOver && Object(styled_components_browser_esm["a" /* css */])(TimeBlock_templateObject2());
}, function (props) {
  return props.timeDirection === "horizontal" ? Object(styled_components_browser_esm["a" /* css */])(TimeBlock_templateObject3(), props.size) : Object(styled_components_browser_esm["a" /* css */])(TimeBlock_templateObject4(), props.size);
});

var TimeBlock_calculateNewEvent = function calculateNewEvent(blockTime, minutesDelta, item, _ref) {
  var EVENT = _ref.EVENT,
      HORIZON_TOP = _ref.HORIZON_TOP,
      HORIZON_BOTTOM = _ref.HORIZON_BOTTOM;
  var start = item.type === EVENT ? moment_default()(blockTime.start) : moment_default()(item.start);
  var end = item.type === EVENT ? moment_default()(blockTime.end) : moment_default()(item.end);
  if (HORIZON_TOP === item.type) start.set({
    h: moment_default()(item.start).add(minutesDelta, "minutes").hour(),
    m: moment_default()(item.start).add(minutesDelta, "minutes").minutes()
  });else if (HORIZON_BOTTOM === item.type) end.set({
    h: moment_default()(item.end).add(minutesDelta, "minutes").hour(),
    m: moment_default()(item.end).add(minutesDelta, "minutes").minutes()
  });else {
    start.set({
      h: moment_default()(item.start).add(minutesDelta, "minutes").hour(),
      m: moment_default()(item.start).add(minutesDelta, "minutes").minutes()
  ...
  return {
    ...
    duration: moment_default.a.duration(end.diff(start)).asMinutes()
  };
};

var TimeBlock_TimeBlock = function TimeBlock(_ref2) {
  var children = _ref2.children,
      label = _ref2.label,
      events = _ref2.events,
      occupancy = _ref2.occupancy,
      start = _ref2.start,
      end = _ref2.end;

  var _useContext = Object(react["useContext"])(CalendarContext),
      timeDirection = _useContext.timeDirection,
      timeBlockMinutes = _useContext.timeBlockMinutes,
      blockPixelSize = _useContext.blockPixelSize,
      showPreview = _useContext.showPreview,
      updateEvent = _useContext.updateEvent,
      dragMode = _useContext.dragMode,
      toggleDragMode = _useContext.toggleDragMode,
      blockLabel = _useContext.blockLabel;

  var _useDrop = Object(lib["useDrop"])({
    accept: [ItemTypes.EVENT, ItemTypes.HORIZON_TOP, ItemTypes.HORIZON_BOTTOM],
    drop: function drop(item, monitor) {
      var coord = monitor.getDifferenceFromInitialOffset();
      var minutesDelta = timeDirection === "horizontal" ? Math.round(coord.x / blockPixelSize) * timeBlockMinutes : Math.round(coord.y / blockPixelSize) * timeBlockMinutes;
      var newEvent = TimeBlock_calculateNewEvent({
        start: start,
        end: end
      }, minutesDelta, item, ItemTypes);
      var updatedEvent = {
        index: item.index,
    ...
    collect: function collect(monitor) {
      ...
      _useDrop2 = TimeBlock_slicedToArray(_useDrop, 2),
      isOver = _useDrop2[0].isOver,
      drop = _useDrop2[1];

  return react_default.a.createElement(Block, {
    ref: drop,
    timeDirection: timeDirection,
    isOver: isOver,
    dragMode: dragMode,
    size: "".concat(blockPixelSize, "px"),
    ocupied: occupancy.length > 0
  }, blockLabel && blockLabel(start, end, events, occupancy), children);
};
TimeBlock_TimeBlock.propTypes = {
  events: prop_types_default.a.array,
  occupancy: prop_types_default.a.array,
  start: prop_types_default.a.object.isRequired
};
TimeBlock_TimeBlock.defaultProps = {
  events: null,
  occupancy: []
};
// CONCATENATED MODULE: ./src/calendar/DayTimeline.js
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
function DayTimeline_templateObject4() {
  var data = DayTimeline_taggedTemplateLiteral(["\n    flex-direction: column;\n  "]);

  DayTimeline_templateObject4 = function _templateObject4() {
    return data;
  };
...
function DayTimeline_templateObject3() {
  var data = DayTimeline_taggedTemplateLiteral(["\n    flex-direction: row;\n  "]);

  DayTimeline_templateObject3 = function _templateObject3() {
    return data;
  };
...
function DayTimeline_templateObject2() {
  var data = DayTimeline_taggedTemplateLiteral(["\n    width: ", ";\n  "]);

  DayTimeline_templateObject2 = function _templateObject2() {
    return data;
  };
...
function DayTimeline_templateObject() {
  var data = DayTimeline_taggedTemplateLiteral(["\n  box-sizing: border-box;\n  font-size: 10px;\n  border-right: 1px solid grey;\n  display: flex;\n  position: relative;\n\n  ", "\n\n"]);

  DayTimeline_templateObject = function _templateObject() {
    return data;
  };
...
function DayTimeline_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var DayTimeline_ItemTypes = {
  EVENT: "event"
};
var Day = styled_components_browser_esm["b" /* default */].div(DayTimeline_templateObject(), function (props) {
  return Object(styled_components_browser_esm["a" /* css */])(DayTimeline_templateObject2(), props.width);
});
var getDayComponent = {
  horizontal: Object(styled_components_browser_esm["b" /* default */])(Day)(DayTimeline_templateObject3()),
  vertical: Object(styled_components_browser_esm["b" /* default */])(Day)(DayTimeline_templateObject4())
};
var DayTimeline_DayTimeline = function DayTimeline(_ref) {
  var events = _ref.events,
      date = _ref.date,
      isActive = _ref.isActive,
      width = _ref.width,
      timesToShow = _ref.timesToShow;

  var _useContext = Object(react["useContext"])(CalendarContext),
      timeDirection = _useContext.timeDirection,
      dayLabel = _useContext.dayLabel;

  var DayComponent = getDayComponent[timeDirection];
  var times = timesToShow.map(function (_ref2, i) {
    var startTime = _ref2.startTime,
        endTime = _ref2.endTime,
        rest = _objectWithoutProperties(_ref2, ["startTime", "endTime"]);

    var start = moment_default()(date).set({
      h: startTime.hours(),
      m: startTime.minutes()
    });
    var end = moment_default()(date).set({
      h: endTime.hours(),
      m: endTime.minutes()
    });
    return {
      ...
      events: events.filter(function (e) {
        return e.start.isBetween(start, end) || e.start.isSame(start);
      }),
      occupancy: events.filter(function (e) {
        return e.start.isBetween(start, end) || e.start.isBefore(start) && e.end.isAfter(end) || e.end.isBetween(start, end);
      })
    };
  });
  if (!date) return "Loading...";
  return react_default.a.createElement(DayComponent, {
    width: width,
    active: isActive
  }, timeDirection === "vertical" && dayLabel && dayLabel(date), times.map(function (t) {
    return react_default.a.createElement(TimeBlock_TimeBlock, {
      key: t.index,
      label: t.label,
      start: t.start,
      end: t.end,
      ...
      return react_default.a.createElement(Event_Event, _extends({
        key: i
      }, e));
    }));
  }));
};
DayTimeline_DayTimeline.propTypes = {
  events: prop_types_default.a.array,
  isActive: prop_types_default.a.bool,
  date: prop_types_default.a.object
};
DayTimeline_DayTimeline.defaultProps = {
  isActive: false,
  date: null,
  events: []
};
// CONCATENATED MODULE: ./src/calendar/DayBlock.js




var DayBlock_DayBlock = function DayBlock(_ref) {
  var days = _ref.days,
      events = _ref.events,
      timesToShow = _ref.timesToShow;

  var _useContext = Object(react["useContext"])(CalendarContext),
      dayDirection = _useContext.dayDirection,
      viewMode = _useContext.viewMode,
      dayWidth = _useContext.dayWidth,
      activeDate = _useContext.activeDate;

  return days.map(function (d, i) {
    return react_default.a.createElement(DayTimeline_DayTimeline, {
      key: i,
      date: d,
      ...
      events: events.filter(function (e) {
        return e.start.isBetween(d, moment_default()(d).add(1, "day")) || e.start.isSame(d);
      })
    });
  });
};
// CONCATENATED MODULE: ./src/calendar/HorizontalDay.js
function HorizontalDay_templateObject3() {
  var data = HorizontalDay_taggedTemplateLiteral(["\n    min-width: ", "px;\n  "]);

  HorizontalDay_templateObject3 = function _templateObject3() {
    return data;
  };
...
function HorizontalDay_templateObject2() {
  var data = HorizontalDay_taggedTemplateLiteral(["\n  box-sizing: border-box;\n  display: block;\n  background: #f1f1f1;\n  padding: 5px;\n  overflow: hidden;\n  ", "\n"]);

  HorizontalDay_templateObject2 = function _templateObject2() {
    return data;
  };
...
function HorizontalDay_templateObject() {
  var data = HorizontalDay_taggedTemplateLiteral(["\n  box-sizing: border-box;\n  width: 100%;\n  display: flex;\n  justify-content: left;\n"]);

  HorizontalDay_templateObject = function _templateObject() {
    return data;
  };
...
function HorizontalDay_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }





var HorizontalDay_Day = styled_components_browser_esm["b" /* default */].div(HorizontalDay_templateObject());
var HorizontalLabel = styled_components_browser_esm["b" /* default */].div(HorizontalDay_templateObject2(), function (props) {
  return Object(styled_components_browser_esm["a" /* css */])(HorizontalDay_templateObject3(), props.minWidth);
});
var HorizontalDay_HorizontalDay = function HorizontalDay(_ref) {
  var events = _ref.events,
      days = _ref.days,
      yAxis = _ref.yAxis,
      timesToShow = _ref.timesToShow;
  ...
  var _useContext = Object(react["useContext"])(CalendarContext),
      yAxisWidth = _useContext.yAxisWidth;

  return yAxis.map(function (row, i) {
    return react_default.a.createElement(HorizontalDay_Day, {
      key: i
    }, react_default.a.createElement(HorizontalLabel, {
      minWidth: yAxisWidth
    }, row.label), react_default.a.createElement(DayBlock_DayBlock, {
      timesToShow: timesToShow,
      key: row.index,
      days: days,
      events: row.events
...
function Calendar_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { keys.push.apply(keys, Object.getOwnPropertySymbols(object)); } if (enumerableOnly) keys = keys.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); return keys; }

function Calendar_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { Calendar_ownKeys(source, true).forEach(function (key) { Calendar_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { Calendar_ownKeys(source).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
function Calendar_templateObject5() {
  ...
  Calendar_templateObject5 = function _templateObject5() {
    return data;
  };
...
function Calendar_templateObject4() {
  var data = Calendar_taggedTemplateLiteral(["\n    flex-direction: row;\n  "]);

  Calendar_templateObject4 = function _templateObject4() {
    return data;
  };
...
function Calendar_templateObject3() {
  var data = Calendar_taggedTemplateLiteral(["\n        margin-left: ", "px;\n        width: ", "px;\n    "]);

  Calendar_templateObject3 = function _templateObject3() {
    return data;
  };
...
function Calendar_templateObject2() {
  var data = Calendar_taggedTemplateLiteral(["\n    width: 100%;\n    margin: 0;\n    padding: 0;\n    font-size: 12px;\n    background: #b1b1b1;\n    li{\n        display: inline-block;\n        list-style: none;\n    }\n    ", "\n"]);

  Calendar_templateObject2 = function _templateObject2() {
    return data;
  };
...
function Calendar_templateObject() {
  var data = Calendar_taggedTemplateLiteral(["\n  box-sizing: border-box;\n  width: 100%;\n  overflow-y: auto;\n  display: flex;\n  justify-content: space-evenly;\n"]);

  Calendar_templateObject = function _templateObject() {
    return data;
  };
...
var CalendarContext = react_default.a.createContext(null); // Create a <Title> react component that renders an <h1> which is
// centered, palevioletred and sized at 1.5em

var Frame = styled_components_browser_esm["b" /* default */].div(Calendar_templateObject());
var Time = styled_components_browser_esm["b" /* default */].ul(Calendar_templateObject2(), function (props) {
  return Object(styled_components_browser_esm["a" /* css */])(Calendar_templateObject3(), props.yAxisWidth, props.width);
});
var getLayout = {
  horizontal: Object(styled_components_browser_esm["b" /* default */])(Frame)(Calendar_templateObject4()),
  vertical: Object(styled_components_browser_esm["b" /* default */])(Frame)(Calendar_templateObject5())
};
...
var Calendar_generateAxis = function generateAxis(events) {
  ...
  var _loop = function _loop(key) {
    axis.push({
      label: key,
      events: events[key].map(function (e, i) {
        e.index = key + i;
        e.duration = moment_default.a.duration(e.end.diff(e.start)).asMinutes();
        return e;
      })
    });
  };
...
var Calendar_Calendar = function Calendar(_ref) {
  var daysToShow = _ref.daysToShow,
      events = _ref.events,
      onChange = _ref.onChange,
      rest = Calendar_objectWithoutProperties(_ref, ["daysToShow", "events", "onChange"]);

  //calendar active date
  var activeDate = rest.activeDate ? rest.activeDate : moment_default()().startOf("day");
  var yAxis = [];

  var _useState = Object(react["useState"])(events),
      _useState2 = Calendar_slicedToArray(_useState, 2),
      calendarEvents = _useState2[0],
      setCalendarEvents = _useState2[1];

  var _useState3 = Object(react["useState"])(false),
      _useState4 = Calendar_slicedToArray(_useState3, 2),
      dragMode = _useState4[0],
      setDragMode = _useState4[1];

  var _useState5 = Object(react["useState"])({
    days: rest.dayDirection,
    time: rest.timeDirection
  }),
      _useState6 = Calendar_slicedToArray(_useState5, 2),
      direction = _useState6[0],
      setDirection = _useState6[1];

  if (Array.isArray(calendarEvents)) {
    if (calendarEvents.length > 0 && typeof calendarEvents[0].index === 'undefined') setCalendarEvents(calendarEvents.map(function (e, i) {
      return Calendar_objectSpread({
        index: i,
        duration: moment_default.a.duration(e.end.diff(e.start)).asMinutes()
      }, e);
    }));
  } else {
    //The timeDirection set to horizontal because the events came as an object
    if (direction.days !== "vertical" || direction.time !== "horizontal") setDirection({
      days: "vertical",
      time: "horizontal"
    });
    yAxis = Calendar_generateAxis(calendarEvents);
  }

  var times = _toConsumableArray(Array(60 * 24 / rest.timeBlockMinutes)).map(function (n, i) {
    var start = moment_default()().startOf("day").add(i * rest.timeBlockMinutes, "minutes");
    var end = moment_default()(start).add(rest.timeBlockMinutes, "minutes");
    return {
      startTime: start,
      endTime: end
    };
  ...
  var Layout = getLayout[direction.days];
  return react_default.a.createElement(Layout, null, react_default.a.createElement(lib["DndProvider"], {
    backend: react_dnd_html5_backend_lib
  }, react_default.a.createElement(CalendarContext.Provider, {
    value: Calendar_objectSpread({}, rest, {
      yAxis: yAxis,
      timeDirection: direction.time,
      activeDate: activeDate,
      dragMode: dragMode,
      toggleDragMode: function toggleDragMode() {
        var value = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
        return value ? setDragMode(value) : setDragMode(!dragMode);
      },
      updateEvent: function updateEvent(uEv) {
        if (onChange) {
          onChange(uEv);
          var newEvents = yAxis.length === 0 ? calendarEvents.map(function (e) {
            return e.index === uEv.index ? Calendar_objectSpread({}, e, {}, uEv) : e;
          }) : function () {
            var newEvents = {};
            yAxis.forEach(function (key) {
              newEvents[key.label] = key.events.map(function (e) {
                return e.index === uEv.index ? Calendar_objectSpread({}, e, {}, uEv) : e;
              });
            });
            return newEvents;
  ...
  }, Array.isArray(calendarEvents) ? react_default.a.createElement(DayBlock_DayBlock, {
    timesToShow: times,
    days: daysToShow,
    events: calendarEvents
  }) : react_default.a.createElement("div", null, daysToShow.map(function (d, i) {
    return react_default.a.createElement("div", {
      key: i
    }, rest.dayLabel && react_default.a.createElement("div", {
      style: {
        width: 60 * 24 / rest.timeBlockMinutes * rest.blockPixelSize,
        marginLeft: i === 0 ? rest.yAxisWidth + "px" : "0"
      }
    }, rest.dayLabel(d, moment_default()(activeDate).add(1, "day").isSame(d))), react_default.a.createElement(Time, {
  ...
  }), react_default.a.createElement(HorizontalDay_HorizontalDay, {
    days: daysToShow,
    timesToShow: times,
    events: calendarEvents,
    yAxis: yAxis
...
Calendar_Calendar.propTypes = {
  timeDirection: prop_types_default.a.string,
  dayDirection: prop_types_default.a.string,
  blockPixelSize: prop_types_default.a.number,
  onChange: prop_types_default.a.func,
  daysToShow: prop_types_default.a.array,
  viewMode: prop_types_default.a.string,
  activeDate: prop_types_default.a.object,
  events: prop_types_default.a.oneOfType([prop_types_default.a.array, prop_types_default.a.object]),
  timeBlockMinutes: prop_types_default.a.number,
  dayWidth: prop_types_default.a.string,
  yAxisWidth: prop_types_default.a.number,
  showFrom: prop_types_default.a.number,
  showUntil: prop_types_default.a.number,
  blockLabel: prop_types_default.a.oneOfType([prop_types_default.a.func, prop_types_default.a.node]),
  dayLabel: prop_types_default.a.oneOfType([prop_types_default.a.func, prop_types_default.a.node])
};
...
/* harmony default export */ var calendar_Calendar = __webpack_exports__["default"] = (Calendar_Calendar);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(21), __webpack_require__(179)(module)))
...
/* harmony import */ var _DndContext__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9);
function _objectWithoutProperties(source, excluded) { if (source == null) return {}; var target = _objectWithoutPropertiesLoose(source, excluded); var key, i; if (Object.getOwnPropertySymbols) { var sourceSymbolKeys = Object.getOwnPropertySymbols(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if (excluded.indexOf(key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }
...
"use strict";
/* harmony import */ var _monitors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(26);
...
/* harmony import */ var _hooksApi__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(27);
...
/* harmony import */ var _options__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(28);
...
/* harmony import */ var _connectors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(29);
...
"use strict";
/* harmony import */ var _DragSource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(163);
/* unused harmony reexport * */
/* harmony import */ var _DropTarget__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(162);
/* unused harmony reexport * */
/* harmony import */ var _DragLayer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(31);
/* unused harmony reexport * */
/* harmony import */ var _interfaces__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(32);
...
"use strict";
/* unused harmony export DragLayer */
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var shallowequal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6);
...
/* harmony import */ var hoist_non_react_statics__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(16);
...
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8);
/* harmony import */ var _utils_js_utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(5);
...
function DragLayer(collect) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  Object(_utils__WEBPACK_IMPORTED_MODULE_6__[/* checkDecoratorArguments */ "a"])('DragLayer', 'collect[, options]', collect, options);
  ...
  invariant__WEBPACK_IMPORTED_MODULE_3___default()(Object(_utils_js_utils__WEBPACK_IMPORTED_MODULE_5__[/* isPlainObject */ "b"])(options), 'Expected "options" provided as the second argument to DragLayer to be a plain object when specified. ' + 'Instead, received %s. Read more: http://react-dnd.github.io/react-dnd/docs/api/drag-layer', options);
  return function decorateLayer(DecoratedComponent) {
    ...
    function (_React$Component) {
      ...
      function DragLayerContainer() {
        ...
        _defineProperty(_assertThisInitialized(_this), "ref", react__WEBPACK_IMPORTED_MODULE_0__["createRef"]());
      ...
      _createClass(DragLayerContainer, [{
        ...
        value: function render() {
          ...
          return react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_index__WEBPACK_IMPORTED_MODULE_4__["DndContext"].Consumer, null, function (_ref) {
            ...
            return react__WEBPACK_IMPORTED_MODULE_0__["createElement"](Decorated, _extends({}, _this2.props, _this2.state, {
              ref: Object(_utils__WEBPACK_IMPORTED_MODULE_6__[/* isRefable */ "c"])(Decorated) ? _this2.ref : null
            }));
          });
        }
      }, {
...
// CONCATENATED MODULE: ./node_modules/react-dnd/lib/hooks/internal/useCollector.js
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _nonIterableRest(); }
...
function useCollector(monitor, collect, onUpdate) {
  ...
  Object(react["useLayoutEffect"])(updateCollected, []);
  return [collected, updateCollected];
}
// CONCATENATED MODULE: ./node_modules/react-dnd/lib/hooks/internal/useMonitorOutput.js
...
function useMonitorOutput_iterableToArrayLimit(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }
...
function useMonitorOutput(monitor, collect, onCollect) {
  ...
  Object(react["useLayoutEffect"])(function subscribeToMonitorStateChange() {
...
// EXTERNAL MODULE: ./node_modules/react-dnd/lib/common/registration.js
var registration = __webpack_require__(10);

// EXTERNAL MODULE: ./node_modules/react-dnd/lib/common/DndContext.js + 29 modules
var DndContext = __webpack_require__(9);

// CONCATENATED MODULE: ./node_modules/react-dnd/lib/hooks/internal/useDragDropManager.js
...
function useDragDropManager() {
  var _useContext = Object(react["useContext"])(DndContext["a" /* DndContext */]),
      dragDropManager = _useContext.dragDropManager;

  browser_default()(dragDropManager != null, 'Expected drag drop context');
  return dragDropManager;
}
// EXTERNAL MODULE: ./node_modules/react-dnd/lib/common/DragSourceMonitorImpl.js
var DragSourceMonitorImpl = __webpack_require__(12);

// EXTERNAL MODULE: ./node_modules/react-dnd/lib/common/SourceConnector.js
var SourceConnector = __webpack_require__(13);

// CONCATENATED MODULE: ./node_modules/react-dnd/lib/hooks/internal/drag.js
...
function useDragSourceMonitor() {
  ...
  var monitor = Object(react["useMemo"])(function () {
    return new DragSourceMonitorImpl["a" /* DragSourceMonitorImpl */](manager);
  }, [manager]);
  var connector = Object(react["useMemo"])(function () {
    return new SourceConnector["a" /* SourceConnector */](manager.getBackend());
  }, [manager]);
...
function useDragHandler(spec, monitor, connector) {
    ...
    return {
      beginDrag: function beginDrag() {
        ...
        if (begin) {
          ...
          browser_default()(beginResult == null || _typeof(beginResult) === 'object', 'dragSpec.begin() must either return an object, undefined, or null');
  ...
  Object(react["useLayoutEffect"])(function registerHandler() {
...
// CONCATENATED MODULE: ./node_modules/react-dnd/lib/hooks/useDrag.js
...
// EXTERNAL MODULE: ./node_modules/react-dnd/lib/common/TargetConnector.js
var TargetConnector = __webpack_require__(14);

// EXTERNAL MODULE: ./node_modules/react-dnd/lib/common/DropTargetMonitorImpl.js
var DropTargetMonitorImpl = __webpack_require__(15);

// CONCATENATED MODULE: ./node_modules/react-dnd/lib/hooks/internal/drop.js
...
function drop_iterableToArrayLimit(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }
...
function useDropTargetMonitor() {
  var manager = useDragDropManager();
  var monitor = Object(react["useMemo"])(function () {
    return new DropTargetMonitorImpl["a" /* DropTargetMonitorImpl */](manager);
  }, [manager]);
  var connector = Object(react["useMemo"])(function () {
    return new TargetConnector["a" /* TargetConnector */](manager.getBackend());
  }, [manager]);
  return [monitor, connector];
}
...
// CONCATENATED MODULE: ./node_modules/react-dnd/lib/hooks/useDrop.js
...
function useDrop_iterableToArrayLimit(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }
...
// CONCATENATED MODULE: ./node_modules/react-dnd/lib/hooks/useDragLayer.js
function useDragLayer_slicedToArray(arr, i) { return useDragLayer_arrayWithHoles(arr) || useDragLayer_iterableToArrayLimit(arr, i) || useDragLayer_nonIterableRest(); }

function useDragLayer_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance"); }

function useDragLayer_iterableToArrayLimit(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function useDragLayer_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
// CONCATENATED MODULE: ./node_modules/react-dnd/lib/hooks/index.js
/* concated harmony reexport useDrag */__webpack_require__.d(__webpack_exports__, "a", function() { return useDrag; });
/* concated harmony reexport useDrop */__webpack_require__.d(__webpack_exports__, "b", function() { return useDrop; });
/* unused concated harmony import useDragLayer */
...
// EXTERNAL MODULE: ./node_modules/react-dnd/lib/common/DndProvider.js
var DndProvider = __webpack_require__(24);

// EXTERNAL MODULE: ./node_modules/react/index.js
var react = __webpack_require__(1);

// CONCATENATED MODULE: ./node_modules/react-dnd/lib/common/DragPreviewImage.js
...
// CONCATENATED MODULE: ./node_modules/react-dnd/lib/common/index.js
/* concated harmony reexport DndContext */__webpack_require__.d(__webpack_exports__, "a", function() { return DndContext["a" /* DndContext */]; });
/* unused concated harmony import createDndContext */
/* concated harmony reexport DndProvider */__webpack_require__.d(__webpack_exports__, "b", function() { return DndProvider["a" /* DndProvider */]; });
/* unused concated harmony import DragPreviewImage */
...
// EXTERNAL MODULE: ./node_modules/react-dnd/lib/utils/isValidType.js
var isValidType = __webpack_require__(18);
...
// EXTERNAL MODULE: ./node_modules/react-dnd/lib/decorators/decorateHandler.js + 1 modules
var decorateHandler = __webpack_require__(19);

// CONCATENATED MODULE: ./node_modules/react-dnd/lib/decorators/createTargetFactory.js
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var createTargetFactory_TargetImpl =
/*#__PURE__*/
function () {
...
function createTargetFactory(spec) {
  Object.keys(spec).forEach(function (key) {
    browser_default()(ALLOWED_SPEC_METHODS.indexOf(key) > -1, 'Expected the drop target specification to only have ' + 'some of the following keys: %s. ' + 'Instead received a specification with an unexpected "%s" key. ' + 'Read more: http://react-dnd.github.io/react-dnd/docs/api/drop-target', ALLOWED_SPEC_METHODS.join(', '), key);
    browser_default()(typeof spec[key] === 'function', 'Expected %s in the drop target specification to be a function. ' + 'Instead received a specification with %s: %s. ' + 'Read more: http://react-dnd.github.io/react-dnd/docs/api/drop-target', key, key, spec[key]);
  });
  return function createTarget(monitor, ref) {
    return new createTargetFactory_TargetImpl(spec, monitor, ref);
  };
}
// CONCATENATED MODULE: ./node_modules/react-dnd/lib/decorators/DropTarget.js
/* unused harmony export DropTarget */
...
function DropTarget(type, spec, collect) {
  ...
  if (typeof type !== 'function') {
    browser_default()(Object(isValidType["a" /* isValidType */])(type, true), 'Expected "type" provided as the first argument to DropTarget to be ' + 'a string, an array of strings, or a function that returns either given ' + 'the current props. Instead, received %s. ' + 'Read more: http://react-dnd.github.io/react-dnd/docs/api/drop-target', type);
  ...
  browser_default()(Object(js_utils["b" /* isPlainObject */])(spec), 'Expected "spec" provided as the second argument to DropTarget to be ' + 'a plain object. Instead, received %s. ' + 'Read more: http://react-dnd.github.io/react-dnd/docs/api/drop-target', spec);
  var createTarget = createTargetFactory(spec);
  browser_default()(typeof collect === 'function', 'Expected "collect" provided as the third argument to DropTarget to be ' + 'a function that returns a plain object of props to inject. ' + 'Instead, received %s. ' + 'Read more: http://react-dnd.github.io/react-dnd/docs/api/drop-target', collect);
  browser_default()(Object(js_utils["b" /* isPlainObject */])(options), 'Expected "options" provided as the fourth argument to DropTarget to be ' + 'a plain object when specified. ' + 'Instead, received %s. ' + 'Read more: http://react-dnd.github.io/react-dnd/docs/api/drop-target', collect);
  return function decorateTarget(DecoratedComponent) {
    return Object(decorateHandler["a" /* default */])({
      ...
      createConnector: function createConnector(backend) {
        return new TargetConnector["a" /* TargetConnector */](backend);
      },
...
// CONCATENATED MODULE: ./node_modules/react-dnd/lib/decorators/createSourceFactory.js
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
// CONCATENATED MODULE: ./node_modules/react-dnd/lib/decorators/DragSource.js
/* unused harmony export DragSource */
...
function DragSource(type, spec, collect) {
  ...
  return function decorateSource(DecoratedComponent) {
    return Object(decorateHandler["a" /* default */])({
      ...
      createConnector: function createConnector(backend) {
        return new SourceConnector["a" /* SourceConnector */](backend);
      },
      createMonitor: function createMonitor(manager) {
        return new DragSourceMonitorImpl["a" /* DragSourceMonitorImpl */](manager);
      },
...
var CalendarView = __webpack_require__(173)["default"];
var Calendar = __webpack_require__(22)["default"];
...
var getDaysOfWeek = function getDaysOfWeek(activeDate) {
  var start = moment__WEBPACK_IMPORTED_MODULE_3___default()(activeDate).startOf("week");
  var end = moment__WEBPACK_IMPORTED_MODULE_3___default()(activeDate).endOf("week");
  var days = [start];
  var current = moment__WEBPACK_IMPORTED_MODULE_3___default()(start).add(1, "day");

  while (current.isBefore(end)) {
    days.push(current);
    current = moment__WEBPACK_IMPORTED_MODULE_3___default()(current).add(1, "day");
  }
...
var CalendarView = function CalendarView(_ref) {
  var events = _ref.events,
      ...
      dayDirection = _ref.dayDirection,
      _onChange = _ref.onChange,
      viewMode = _ref.viewMode,
      dayLabel = _ref.dayLabel,
      blockLabel = _ref.blockLabel,
...
CalendarView.propTypes = {
  viewMode: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string,
  onChange: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.func,
  showPreview: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.bool,
  events: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.array, prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.object]),
  timeBlockMinutes: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number,
  yAxisWidth: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number,
  blockLabel: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.func, prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.node]),
  dayLabel: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.func, prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.node]),
  activeDate: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.object
};
